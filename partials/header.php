...
<header class="site-header" id="site-header">
  <div class="container header-inner">
    <a href="<?= htmlspecialchars(site_url(), ENT_QUOTES, 'UTF-8') ?>" class="logo-link" aria-label="Garten2000+mehr – Startseite">
      <img src="<?= htmlspecialchars(asset_url('img/logo.png'), ENT_QUOTES, 'UTF-8') ?>" alt="Garten2000+mehr Logo" class="logo-img" width="200" height="52">
    </a>
